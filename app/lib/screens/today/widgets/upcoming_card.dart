          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Expanded(
                  child: Text(
                    state.predictionSource == 'on-device model'
                        ? 'MODEL · ${state.predictionModelVersion.toUpperCase()}'
                        : 'MODEL · POPULATION PRIOR',
                    style: Type.mono(
                      size: 10,
                      color: Tokens.graphite2,
                      letterSpacingEm: 0.06,
...
String _uncertaintyMeta(CycleState state) {
  final window = state.predictedP80WindowDays?.round();
  if (window != null) return '80% WINDOW · $window DAYS';
  return '${state.cycleCount} START${state.cycleCount == 1 ? '' : 'S'} · ${state.observationCount} OBS';
}
    ...
    return SizedBox(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final todayX = axisLeft + state.todayPos.clamp(0.0, 1.0) * axisWidth;
          ...
          return Stack(
            ...
            children: [
              ...
              // Mid tick + label for the current prediction range.
              Positioned(
              ...
              // Today label, centered under the dot.
              Positioned(
                left: todayX - 16,
                top: axisY + 9,
                width: 32,
