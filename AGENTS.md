...
_Auto-compiled 2026-05-02 14:33 UTC - 8 doc(s) found._
<!-- DOCS:END -->

## Before Every Commit

1. Update relevant `AGENTS.md` files when project shape changes.
2. Run `python3 scripts/compile_docs.py` after adding, removing, or renaming `AGENTS.md` files.
3. Run `pytest`.
4. For deploy confidence, run Docker-based tests when Docker is available.
